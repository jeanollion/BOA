...
public class OpWrapper {
    public static final Logger logger = LoggerFactory.getLogger(OpWrapper.class);
    final OpService service;
    public OpWrapper(OpService service) {
        this.service=service;
    }
    public Parameter[] getParameters(OpInfo info) {
    ...
    public static Parameter mapParameter(ModuleItem<?> param) {
