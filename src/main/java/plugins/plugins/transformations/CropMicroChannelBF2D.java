...
public class CropMicroChannelBF2D extends CropMicroChannels {
    ...
    public BoundingBox getBoundingBox(Image image, int cropMargin, int margin, int channelHeight, int channelWidth, int widthMin, int widthMax, int xStart, int xStop, int yStart, int yStop, int yStartAdjustWindow, double localExtremaThld, int yMarginEndChannel) {
