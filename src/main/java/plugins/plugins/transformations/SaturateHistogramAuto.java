...
public class SaturateHistogramAuto implements Transformation {
    ...
    NumberParameter sigmaStart = new BoundedNumberParameter("Saturate value start (sigma)", 1, 2, 0, null); 
    NumberParameter sigmaEnd = new BoundedNumberParameter("Saturate value start (end)", 1, 4, 0, null);
    ...
    public Image applyTransformation(int channelIdx, int timePoint, Image image) {
        ...
        SaturateHistogram.saturate(thldStart, thldEnd, image);
        return image;
    }
