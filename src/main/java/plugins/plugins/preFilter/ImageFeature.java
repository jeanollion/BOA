...
public class ImageFeature implements PreFilter {
    ChoiceParameter feature = new ChoiceParameter("Feature", new String[]{"Gaussian Smooth", "Gradient", "Laplacian", "Hessian Max", "Hessian Det"}, "Gaussian Smooth", false);
    ConditionalParameter cond = new ConditionalParameter(feature);
    ScaleXYZParameter scale = new ScaleXYZParameter("Scale", 2, 1, true);
    
    public ImageFeature() {
        
        cond.setDefaultParameters(new Parameter[]{scale});
    }
