...
public class GenerateFastMutTrackingXP {
    ...
    public static void main(String[] args) {
        ...
        mDAO.reset();
        Experiment xp = generateXP(DBUtil.removePrefix(dbName, GUI.DBprefix), outputDir, true, flip, trimStart, trimEnd, cropXYdXdY);
    ...
    public static Experiment generateXP(String name, String outputDir, boolean setUpPreProcessing, boolean flip, int trimFramesStart, int trimFramesEnd, int[] crop) {
