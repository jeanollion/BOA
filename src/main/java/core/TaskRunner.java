...
public class TaskRunner {
    ...
    public static List<Task> getFastTrackTasks() {
        List<Task> tasks = new ArrayList<Task>() {{
            add(new Task("boa_fluo170207_150ms").setActions(false, false, false, false).addExtractMeasurementDir("/data/Images/MutationDynamics/170207", 1).addExtractMeasurementDir("/data/Images/MutationDynamics/170207", 2));
