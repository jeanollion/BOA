...
public interface Measurement extends Plugin {
    /**
     * 
     * @return index of structure of the objects that will be provided to the method {@link Measurement#performMeasurement(dataStructure.objects.StructureObject, java.util.ArrayList) }. 
