...
public class ExtendBounds implements PostFilter, ToolTip {
    ...
    BoundedNumberParameter x1 = new BoundedNumberParameter("X Left", 0, 8, 0, null).setToolTipText("Number of pixel to add to bounds on left side in X direction");
    ChoiceParameter outOfBoundX = new ChoiceParameter("X Left out-of-bound", OUT_OF_BOUNDS_CONDITION.names(), OUT_OF_BOUNDS_CONDITION.KEEP_SIZE.name, false).setToolTipText("In case the extended bounding box is out of the bound of the parent image:<br /><ul><li><em>Trim: </em> The bound is simply set to the bound of the parent image</li><li><em>Keep Global Size: </em> The bounds are translated in order to fit in the parent image and keep a constant size</li><li><em>Keep Center: </em> Bounds are equally trimmed on both sides so that the original bound is still in the middle of the new bounds</li></ul>");
    BoundedNumberParameter x2 = new BoundedNumberParameter("X Right", 0, 8, 0, null).setToolTipText("Number of pixel to add to bounds on right side in X direction");
    BoundedNumberParameter y1 = new BoundedNumberParameter("Y Up", 0, 8, 0, null).setToolTipText("Number of pixel to add to bounds on upper side in Y direction");
    ChoiceParameter outOfBoundY = new ChoiceParameter("Y Up out-of-bound", OUT_OF_BOUNDS_CONDITION.names(), OUT_OF_BOUNDS_CONDITION.TRIM.name, false).setToolTipText("In case the extended bounding box is out of the bound of the parent image:<br /><ul><li><em>Trim: </em> The bound is simply set to the bound of the parent image</li><li><em>Keep Global Size: </em> The bounds are translated in order to fit in the parent image and keep a constant size</li><li><em>Keep Center: </em> Bounds are equally trimmed on both sides so that the original bound is still in the middle of the new bounds</li></ul>");
    BoundedNumberParameter y2 = new BoundedNumberParameter("Y Down", 0, 0, 0, null).setToolTipText("Number of pixel to add to bounds on lower side in Y direction");
    BoundedNumberParameter z1 = new BoundedNumberParameter("Z Up", 0, 0, 0, null).setToolTipText("Number of pixel to add to bounds on upper side in Z direction");
    ChoiceParameter outOfBoundZ = new ChoiceParameter("Z Up out-of-bound", OUT_OF_BOUNDS_CONDITION.names(), OUT_OF_BOUNDS_CONDITION.TRIM.name, false).setToolTipText("In case the extended bounding box is out of the bound of the parent image:<br /><ul><li><em>Trim: </em> The bound is simply set to the bound of the parent image</li><li><em>Keep Global Size: </em> The bounds are translated in order to fit in the parent image and keep a constant size</li><li><em>Keep Center: </em> Bounds are equally trimmed on both sides so that the original bound is still in the middle of the new bounds</li></ul>");
    BoundedNumberParameter z2 = new BoundedNumberParameter("Z Down", 0, 0, 0, null).setToolTipText("Number of pixel to add to bounds on lower side in Z direction");
