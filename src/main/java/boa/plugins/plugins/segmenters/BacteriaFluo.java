...
public class BacteriaFluo extends BacteriaIntensitySegmenter<BacteriaFluo> {
    ...
    public BacteriaFluo() {
        localThresholdFactor.setToolTipText("Factor defining the local threshold.  Lower value of this factor will yield in smaller cells. "
