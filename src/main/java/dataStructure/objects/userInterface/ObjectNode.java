...
public class ObjectNode implements TreeNode {
    ...
    public ObjectNode(StructureNode parent, int idx, StructureObject data) {
        ...
        for (int i = 0; i<children.length; ++i) children[i]=new StructureNode(parent.generator, childrenIndicies[i], this);
        this.parent = parent;
    }
    ...
    @Override public String toString() {
        if (isRoot()) return parent.generator.currentFieldName;
        else return "Object: "+idx;
    }
