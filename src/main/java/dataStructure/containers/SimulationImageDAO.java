...
public class SimulationImageDAO implements ImageDAO {
    ...
    public ImageInteger openMask(StructureObject object) {
        throw new UnsupportedOperationException("ImageMask cannot be opened in simulation mode");
    }

    public void writeMask(ImageInteger mask, StructureObject object) {
        throw new UnsupportedOperationException("ImageMask cannot be saved in simulation mode");
    }
